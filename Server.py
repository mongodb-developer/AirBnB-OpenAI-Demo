...
def getPlaces():
    ...
    return json.dumps({"data":json_util.dumps(output_data)}),200 #We return places data with status code 200. We also use json_util from BSON library (included with pymongo package) to let us serialize the output from MongoDB
